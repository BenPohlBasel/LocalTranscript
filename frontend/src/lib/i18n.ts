...
const W: Record<string, Eintrag> = {
  ...
  "ed.meta.rollen.hinweis": {
    de: "Die befragte Person ist nicht vorausgewählt: Ein pseudonymisiertes Transkript soll ihren Namen nicht über Zotero bekommen.",
    en: "The interviewee is not preselected: a pseudonymised transcript should not receive their name via Zotero.",
    fr: "La personne interviewée n’est pas présélectionnée : une transcription pseudonymisée ne doit pas recevoir son nom via Zotero.",
    it: "La persona intervistata non è preselezionata: una trascrizione pseudonimizzata non deve ricevere il suo nome tramite Zotero." },
  "ed.meta.rolle.interviewer": { de: "Interviewer:in", en: "Interviewer",
    fr: "Intervieweur·euse", it: "Intervistatore/trice" },
  "ed.meta.rolle.interviewee": { de: "Befragte Person", en: "Interviewee",
    fr: "Personne interviewée", it: "Persona intervistata" },
  "ed.meta.rolle.author": { de: "Autor:in", en: "Author", fr: "Auteur·ice",
    it: "Autore/trice" },
  "ed.meta.rolle.contributor": { de: "Mitwirkende", en: "Contributor",
    fr: "Contributeur·ice", it: "Collaboratore/trice" },
  "ed.meta.rolle.editor": { de: "Herausgeber:in", en: "Editor",
    fr: "Éditeur·ice", it: "Curatore/trice" },
  "ed.meta.rolle.translator": { de: "Übersetzer:in", en: "Translator",
    fr: "Traducteur·ice", it: "Traduttore/trice" },
  ...
  "st.lizenzen": { de: "Lizenzen", en: "Licenses", fr: "Licences",
    it: "Licenze" },
  "st.lizenzen.text": {
    de: "whisper.cpp (MIT) · Modell large-v3-turbo (OpenAI, MIT) · silero-vad (MIT) · SpeechBrain ECAPA (Apache-2.0) · FastAPI/uvicorn (MIT) · React/Radix (MIT) · Lucide (ISC) · ffmpeg (GPL-Build) — LocalTranscript selbst: AGPL-3.0-or-later.",
    en: "whisper.cpp (MIT) · large-v3-turbo model (OpenAI, MIT) · silero-vad (MIT) · SpeechBrain ECAPA (Apache-2.0) · FastAPI/uvicorn (MIT) · React/Radix (MIT) · Lucide (ISC) · ffmpeg (GPL build) — LocalTranscript itself: AGPL-3.0-or-later.",
    fr: "whisper.cpp (MIT) · modèle large-v3-turbo (OpenAI, MIT) · silero-vad (MIT) · SpeechBrain ECAPA (Apache-2.0) · FastAPI/uvicorn (MIT) · React/Radix (MIT) · Lucide (ISC) · ffmpeg (build GPL) — LocalTranscript : AGPL-3.0-or-later.",
    it: "whisper.cpp (MIT) · modello large-v3-turbo (OpenAI, MIT) · silero-vad (MIT) · SpeechBrain ECAPA (Apache-2.0) · FastAPI/uvicorn (MIT) · React/Radix (MIT) · Lucide (ISC) · ffmpeg (build GPL) — LocalTranscript: AGPL-3.0-or-later." },
