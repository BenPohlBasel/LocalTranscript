...
const W: Record<string, Eintrag> = {
  ...
  "job.fehler": { de: "Fehler", en: "Error", fr: "Erreur",
    it: "Errore" },
  "ed.play": { de: "Abspielen (Shift+Leertaste)",
    en: "Play (Shift+Space)", fr: "Lecture (Maj+Espace)",
    it: "Riproduci (Maiusc+Spazio)" },
  "ed.pause": { de: "Pause (Shift+Leertaste)", en: "Pause (Shift+Space)",
    fr: "Pause (Maj+Espace)", it: "Pausa (Maiusc+Spazio)" },
